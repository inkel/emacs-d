...
** AI
Yes, it's time to accept that AI is not important. At work I've been trying [[https://www.anthropic.com/claude][Claude]], so let's start with it:

#+begin_src emacs-lisp
  ;; ;; Perhaps the most comprehensive client of all
  ;; ;; https://github.com/karthink/gptel
  ;; (use-package gptel
  ;;   ;; :config
  ;;   ;; ;; Configure Claude
  ;;   ;; (cl-flet ((read-key (file) (with-temp-buffer
  ;;   ;;                              (insert-file-contents file)
  ;;   ;;                              (string-trim (buffer-string)))))
  ;;   ;;   (setq gptel-backend (gptel-make-anthropic "Claude"
  ;;   ;;                         :stream t
  ;;   ;;                         :key (read-key "~/dev/.claude.key")
  ;;   ;;                         :models '(claude-sonnet-4-20250514)))
  ;;   ;;   (setopt gptel-api-key (read-key "~/dev/.chatgpt.emacs.key")))
  ;;   )
#+end_src
